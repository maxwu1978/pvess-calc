...
| `phase_h_adjacent_calcs_complete` | Phase H：DC AFCI 证据、NEC 230.67 service SPD 必需位置、H.2 A/B/C/D raceway segments、Chapter 9 conduit fill、ground-rod field-proof 状态。|
...
| **H** | **DC AFCI / SPD / 接地极 / Conduit fill** | `calc/adjacent.py`, doctor `phase_h_adjacent_calcs_complete` | 🟡 H.1/H.2 done；H.3 planned — 见 `ROADMAP.md` |
