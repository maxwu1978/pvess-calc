...
| `phase_h_adjacent_calcs_complete` | Phase H：DC AFCI 证据、NEC 230.67 service SPD 必需位置、H.2 A/B/C/D raceway segments、H.3 configurable raceway Chapter 9 conduit fill、ground-rod field-proof 状态。|
| `regional_requirements_consistent` | Phase I：CA Title 24、HI Rule 14H、TX/Oncor、NYC DOB/FDNY ESS 区域规则汇总；FAIL 为硬错误，MANUAL/WARN 为提交前复核项。|
...
| **H** | **DC AFCI / SPD / 接地极 / Conduit fill** | `calc/adjacent.py`, doctor `phase_h_adjacent_calcs_complete` | ✅ done (2026-05-18) |
| I | NEC 2017 + CA Title 24 + HI Rule 14H + TX Oncor + NYC ESS | `nec/v2017.py`, `regional/*`, doctor `regional_requirements_consistent` | ✅ done (2026-05-18) |
